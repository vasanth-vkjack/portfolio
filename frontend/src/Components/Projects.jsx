    ...
    <section id='projects' className='flex flex-col py-20 px-5 justify-center bg-primary text-white'>
        <div className='w-full'>
            <div className='flex flex-col px-10 py-5'>
                ...
                <p>These are some of my best projects. I have built these with React.js, Node.js, Express and MongoDB. Check them out</p>
            </div>
        </div>
        <div className='w-full'>
            <div className='flex flex-col md:flex-row px-10 gap-5'>
                {config.projects.map((project)=>(
                        ...
                        <div className='relative'>
                            <img className='md:h-[250px] h-[200px] w-[500px]' src={project.image} alt="" />
