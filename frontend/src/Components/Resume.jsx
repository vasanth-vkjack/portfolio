...
export const Resume = () => {
  ...
  const config = {
    link: 'https://drive.google.com/file/d/1jXf-gb5vziAm_uZs1JlXE2ekIlVv3Exy/view?usp=sharing'
  }
  ...
  return (
    <section id='resume' className='flex flex-col md:flex-row bg-secondary px-5'>
        ...
        <div className='flex flex-col justify-center text-white'>
            ...
            <p className='pb-5'>You can view my resume <a className='btn' target='_blank' href={config.link} rel="noreferrer"> Download</a></p>
        </div>
        </div>
    </section>
  )
